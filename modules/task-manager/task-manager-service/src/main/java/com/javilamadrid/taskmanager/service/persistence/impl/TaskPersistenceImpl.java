...
package com.javilamadrid.taskmanager.service.persistence.impl;

import com.javilamadrid.taskmanager.exception.NoSuchTaskException;
import com.javilamadrid.taskmanager.model.Task;
import com.javilamadrid.taskmanager.model.TaskTable;
import com.javilamadrid.taskmanager.model.impl.TaskImpl;
import com.javilamadrid.taskmanager.model.impl.TaskModelImpl;
import com.javilamadrid.taskmanager.service.persistence.TaskPersistence;
import com.javilamadrid.taskmanager.service.persistence.impl.constants.taskPersistenceConstants;
...
public class TaskPersistenceImpl
	...
	@Override
	@Reference(
		target = taskPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = taskPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	private static class TaskModelArgumentsResolver
		...
		static {
			...
			orderByColumnsBitmask |= TaskModelImpl.getColumnBitmask("title");
