...
import com.javilamadrid.taskmanager.model.TaskModel;
import com.javilamadrid.taskmanager.model.TaskSoap;
...
public class TaskModelImpl extends BaseModelImpl<Task> implements TaskModel {
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"priority", Types.INTEGER}, {"deadline", Types.TIMESTAMP},
	...
	public static final String TABLE_SQL_CREATE =
		"create table task_Task (uuid_ VARCHAR(75) null,taskId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,title STRING null,description STRING null,priority INTEGER,deadline DATE null,status INTEGER,statusByUserId LONG,statusByUserName VARCHAR(75) null,statusDate DATE null)";

	public static final String TABLE_SQL_DROP = "drop table task_Task";

	public static final String ORDER_BY_JPQL = " ORDER BY task.title ASC";

	public static final String ORDER_BY_SQL = " ORDER BY task_Task.title ASC";
	...
	public static Task toModel(TaskSoap soapModel) {
		...
		model.setDeadline(soapModel.getDeadline());
	...
	static {
		...
		attributeGetterFunctions.put("deadline", Task::getDeadline);
		attributeSetterBiConsumers.put(
			"deadline", (BiConsumer<Task, Date>)Task::setDeadline);
		attributeGetterFunctions.put("status", Task::getStatus);
		attributeSetterBiConsumers.put(
			"status", (BiConsumer<Task, Integer>)Task::setStatus);
		attributeGetterFunctions.put("statusByUserId", Task::getStatusByUserId);
		attributeSetterBiConsumers.put(
			"statusByUserId", (BiConsumer<Task, Long>)Task::setStatusByUserId);
		attributeGetterFunctions.put(
			"statusByUserName", Task::getStatusByUserName);
		attributeSetterBiConsumers.put(
			"statusByUserName",
			(BiConsumer<Task, String>)Task::setStatusByUserName);
		attributeGetterFunctions.put("statusDate", Task::getStatusDate);
		attributeSetterBiConsumers.put(
			"statusDate", (BiConsumer<Task, Date>)Task::setStatusDate);
	...
	public void prepareLocalizedFieldsForImport() throws LocaleException {
		...
		Locale defaultImportLocale = LocalizationUtil.getDefaultImportLocale(
			Task.class.getName(), getPrimaryKey(), defaultLocale,
			availableLocales);
	...
	public Object clone() {
		...
		taskImpl.setDeadline(getDeadline());
	...
	public CacheModel<Task> toCacheModel() {
		...
		if (deadline != null) {
			taskCacheModel.deadline = deadline.getTime();
		}
		else {
			taskCacheModel.deadline = Long.MIN_VALUE;
		}
	...
	static {
		...
		columnBitmasks.put("deadline", 2048L);
