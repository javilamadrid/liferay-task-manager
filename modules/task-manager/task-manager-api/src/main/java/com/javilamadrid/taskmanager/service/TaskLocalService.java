...
public interface TaskLocalService
	...
	public Task updateTask(
			long taskId, Map<Locale, String> titleMap,
			Map<Locale, String> descriptionMap, Date deadline, int priority)
		throws PortalException;
